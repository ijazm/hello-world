interface IERC20 {
    ...
    function transfer(address _to, uint256 _ value) returns (bool Success);
    function transferFrom(address _from, address _to, uint256 _ value) returns (bool Success);
    function approve(address _spender, uint256 _ value) returns (bool success);
